                ...
                "<div class='ivsom-alien-container'>",
                    "<svg xmlns='http://wwW.w3.org/2000/svg' class='ivsom-alien-drawing' version='1.1' viewBox='0 0 600 600' preserveAspectRatio='xMidYMid'>",
                        ...
                        "<g v-for='(item, i) in getRoadsView' :transform=\"'rotate('+ (-90 + item.angle) +', 300, 300)'\">",
                            "<g>",
                                "<text x='440' y='260' text-anchor='middle' :transform=\"item.angle >= 180 && item.angle<= 330 ? 'rotate(180, 440 260)' : ''\" style='font-size: 18' fill='#333'>{{item.roadName}}</text>",
                                ...
                                "<use x='360' y='280' width='40' height='30' :transform=\"item.arrow === 'left' ? 'rotate(180, 380 300)' : ''\" href='#arrow' />",
                                "<use x='440' y='280' width='40' height='30' :transform=\"item.arrow === 'left' ? 'rotate(180, 460 300)' : ''\" href='#arrow' />",
                                "<use x='520' y='280' width='40' height='30' :transform=\"item.arrow === 'left' ? 'rotate(180, 540 300)' : ''\" href='#arrow' />",
