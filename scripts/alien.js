            ...
            "<div class='ivsom-alien'>",
                ...
                "<div class='ivsom-alien-container'>",
                    "<svg xmlns='http://wwW.w3.org/2000/svg' class='ivsom-alien-drawing' version='1.1' viewBox='0 0 600 600' preserveAspectRatio='xMidYMid'>",
                        "<defs><g id='arrow'><path fill='#fff' d='M29.38201,19.99364l -1.54456,-1.6718l -0.00662,0.00707 l-14.66826,-15.8679 l-1.54456,1.67074 l14.66845,15.86779 l-14.66845,15.86795 l1.54456,1.67054 l14.66826,-15.86774 l0.00662,0.00707 l1.54456,-1.67195 l-0.00551,-0.0059l0.00551,-0.00585z' /></g></defs>",
                        "<g>",
                        ...
                        "</g>",
                        "<g>",
                            "<circle cx='300' cy='300' r='260' fill='none' stroke-width='2' stroke='#a8daff' />",
                            "<circle cx='300' cy='300' r='20' fill='#333' stroke-width='0' stroke='none' />",
                            "<line :x1='item.p1.x' :x2='item.p2.x' :y1='item.p1.y' :y2='item.p2.y' v-for='(item, i) in getScaleList' :key='i' fill='#a8daff' stroke='#a8daff' :stroke-width='i % 5 === 0 ? 5 : 2' />",
                            "<text x='300' y='30' font-size='16' text-anchor='middle' style='font-weight: bold;' fill='#53d551'>0°</text>",
                            "<text x='20' y='305' font-size='16' text-anchor='middle' style='font-weight: bold;' fill='#53d551'>270°</text>",
                            "<text x='300' y='580' font-size='16' text-anchor='middle' style='font-weight: bold;' fill='#53d551'>180°</text>",
                            "<text x='580' y='305' font-size='16' text-anchor='middle' style='font-weight: bold;' fill='#53d551'>90°</text>",
                        "</g>",
                        "<g v-for='(item, i) in getRoadsView' :transform=\"'rotate('+ (-90 + item.angle) +', 300, 300)'\">",
                            "<g>",
                                "<text x='440' y='270' text-anchor='middle' :transform=\"item.angle >= 180 && item.angle<= 330 ? 'rotate(180, 440 265)' : ''\" style='font-size: 18' fill='#333'>{{item.roadName}}</text>",
                                ...
                                "<use x='340' y='280' width='40' height='30' :transform=\"item.arrow === 'left' ? 'rotate(180, 360 300)' : ''\" href='#arrow' />",
                                "<use x='410' y='280' width='40' height='30' :transform=\"item.arrow === 'left' ? 'rotate(180, 430 300)' : ''\" href='#arrow' />",
                                "<use x='480' y='280' width='40' height='30' :transform=\"item.arrow === 'left' ? 'rotate(180, 500 300)' : ''\" href='#arrow' />",
                                "<circle cx='540' cy='300' r='20' fill='#2895fc' stroke-width='0' stroke='none' />",
                                "<text x='540' y='300' font-size='16' style='dominant-baseline:middle;text-anchor:middle;' :transform=\"'rotate('+ (-(-90 + item.angle)) +', 540 300)'\" fill='#fff'>{{ item.arrow === 'left' ? '起' : '终' }}</text>",
                        ...
                        "</g>",
                        "<circle cx='300' cy='300' r='20' fill='#2895fc' stroke-width='0' stroke='none' />",
                        "<text x='300' y='300' font-size='16' style='dominant-baseline:middle;text-anchor:middle;' fill='#fff'>{{ {'start' : '起', 'middle' :  '中', 'end' : '终'}[type] }}</text>",
                    "</svg>",
        ...
        watch: {
            "Roads" : {
                handler: function(val, old) {
                    var me = this;
                    for(var key in val) {
                        if (!old || !old[key] || val[key].type !== old[key].type) {
                            me.type = val[key].type;
                            break;
                        }
                    }
                },
